        ...
        <form name="foto_doacao" type="text" method="post" enctype="multipart/form-data" action="upload.php">
            <label>Foto <input type="file" required name="imagem" />
                ...
                <label>
                    ...
                    <label>
                        <p>E-mail</p> <br><input type="text" name="nome_inf" id="id_email"
                            placeholder="Insira seu E-mail" size="60">
                    </label><br><br>
                    ...
                    <label>
                        <p>Cidade</p> <br><input type="text" name="nome_inf" id="id_cidade"
                            placeholder="Insira sua Cidade" size="60">
                    </label><br><br>
