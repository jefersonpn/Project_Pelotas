...
<body>
    ...
    <div class="posicao_padrao1">
        ...
        <p>
            Você pode doar objetos para pets, a única regra
            é você ir até o parceiro<br> e deixar no local por até 3 dias.
            Caso o protetor não busque,<br> o produto volta ao doador ou será descartado.
        </p><br><br>
        ...
        <section class="container_amigoPet1">
            ...
            <div class="item_escolhe1">
                <a href="doacao_solicitar.html" id="button">Doar</a> <!-- botão -->
            </div>
