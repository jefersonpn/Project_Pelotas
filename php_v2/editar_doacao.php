...
<div class="container">
  ...
  <form method="post" action="atualizar_doacao.php" enctype="multipart/form-data" onsubmit="validaForm(); return false;"
    class="form">
    <div class="row ">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input id="descricao" type="text" name="descricao" class="form-control" required=" required"
                          data-error="Descrição é obrigatório." value=<?php echo $descricao?>>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input id="quantidade" type="number" name="quantidade" class="form-control" required="required"
                          data-error="Quantidade é  obrigatório." value=<?php echo $quantidade ?>>
