...
if(in_array($ext_imagem, $extensions))
{
    ...
    $sqlquery = "INSERT INTO doacao_voluntaria (descricao, status, quantidade, fk_parceiro_id, fk_doador_id, imagem) VALUES ('$descricao', '1', '$quantidade', '$id_parceiro', '$id_doador', '$nome_imagem')";
