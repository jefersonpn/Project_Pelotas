...
?>
 ...
 <div class="container_cadastro">
        ...
        <form method="post" action=""><br><br>
            ...
            <label><input type="radio" name="tipo_usuario" value="1" onchange="formfisica();" />Doador</label>
            ...
            <label><input type="radio" name="tipo_usuario" value="3"
                    ...
                    <!-- AQUI PEGA O FORMULÁRIO DE TODOS AO INVÉS DE PEGAR SOMENTE O SEU,
                    O PROBLEMA PODE SER O FORM QUE É SOMENTE UM ?  -->
